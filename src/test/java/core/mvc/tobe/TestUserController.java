...
public class TestUserController {
    ...
    @RequestMapping(value = "/test/users/string", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/test/users/int-long", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/test/users/javabean", method = RequestMethod.POST)
