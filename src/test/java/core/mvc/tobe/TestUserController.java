...
public class TestUserController {
    ...
    @RequestMapping(value = "/users/strings", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/users/primitives", method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/users/testUser", method = RequestMethod.POST)
